# Archive Collection: update-hub-firm-model.sh
# Source: firm-model/scripts/update-hub.sh
# Collected by Archive Model Script Aggregator

echo "📡 Updating hub constellation with this module..."

MODULE_KEY="firm_model"
REPO_NAME="firm-model"
...
- key: firm_model
  ...
  status: seed
  tags: [the,firm,is]
  description: "The Firm is the promoter"
  repo_url: https://github.com/zbreeden/firm-model
  pages_url: https://zbreeden.github.io/firm-model/
  owners: [zach]
MODULE
